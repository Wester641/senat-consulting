                ...
                <div className="row">
                    ...
                    <div className="col-lg-6 col-12">
                        <div className="about-content">
                            ...
                            <p>Senat Consulting — юридическая и консалтинговая компания, объединяющая опытных юристов и специалистов по организации проектов. Мы внимательно изучаем каждый кейс, разрабатываем стратегию и доводим дело до результата — от переговоров и подготовки документов до судебных решений.</p>
